        ...
        <div class="card">
            <div class="card-body">
                <h5 class="header-title my-3">
                    ...
                    <a href="" target="_blank" class="float-right" data-toggle="tooltip" data-placement="top" title="<?php echo get_phrase('my_cloud'); ?>"><i class="mdi mdi-open-in-new"></i></a>
                </h5>
    ...
    <div class="col-md-5 col-xl-4">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success w-100 mt-2" href="" target="_blank"><?php echo get_phrase('extend_storage'); ?> <i class="mdi mdi-open-in-new"></i></a>
            </div> <!-- end card-->
        </div>
    </div>
</div>